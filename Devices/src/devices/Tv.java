...
// Classe que representa uma TV e implementa a interface Device
public class Tv implements Device {
    // Variável para armazenar se a TV está ligada ou desligada
    private boolean on = false;

    // Variável para armazenar o volume da TV
    private int volume = 30;

    // Variável para armazenar o canal da TV
